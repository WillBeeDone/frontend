...
export default function ShowAll({
  ...
  const offerCardsFinal: IOfferCard[] = isFavotite
    ? favoriteOffers
    : offerCards;
  const setOfferCardsFinal: (offer: IOfferCard[]) => void = isFavotite
    ? setFavoriteOffers
    : setOfferCards;

  // для операций с my offers
  const { isLoading, removeOfferFromMyOffers, activateDeactivateMyOffers } =
    useMyOffers();
        ...
        {offers ? (
          <div className={styles.offerCardMain}>
            <div className={styles.sortButton}>
              <MyButton
                data-testid="MyButtonHomePageSort_JnHb"
                text="Price"
                isSortButton={true}
                offerCards={offerCardsFinal}
                setOfferCards={setOfferCardsFinal}
              />
            </div>
                    ...
                    <div className={styles.heartAndView}>
                      <div>
                        <AddToFavoritesButton
                          data-testid="AddToFavoritesButtonHomePage_HgyfTy"
                          offer={offer}
                        />
                      </div>
                      <div className={styles.view}>
                        ...
                        >
                          <MyButton
                            data-testid="ViewBtnHomePage_Hydgr"
                            variant="primary"
                            text="View"
                          />
                        </Link>
      ...
      <>
        {offer ? (
          <div className={styles.mainContainerOfferPage}>
            <div className={styles.mainPartOfferPage}>
              <div className={styles.leftPartOfferPage}>
                <div className={styles.profileImageContainer}>
                  ...
                  <div className={styles.AddToFavoritesContainer}>
                    <div className={styles.AddToFavoritesBtn}>
                      <AddToFavoritesButton
                        data-testid="AddToFavoritesButtonOfferPage_JnHygdT"
                ...
                {isAuthenticated ? (
                  ...
                  <Link
                    data-testid="LinkSignInOfferPage_fJndhTy"
                    to="/sign-in-form"
                  >
            ...
            <Link
              data-testid="GoBackbtnOfferPage_HLkdyTy"
