...
import { transformOfferCard, transformOfferCardPagination } from "../backToFrontTransformData/BackToFrontTransformData"
...
interface OffersContextType {
  ...
  totalPages: number;
  fetchOffers: (city?: string, category?: string, keyWord?: string, page?: number) => void;
